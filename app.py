...
# ==========================================
    ...
    # [💡 요청사항 반영] 두 번째 탭 메뉴 이름을 명확하게 변경했습니다.
    tabs = st.tabs(["자유낙하운동(등가속도직선운동)", "포물선운동(수평으로 던진 물체의 운동)", "등속 원운동"])
    ...
    # ------------------------------------------
    with tabs[1]:
        # [💡 요청사항 반영] 내부 헤더 제목도 규칙에 맞춰 동일하게 개편했습니다.
        st.subheader("■ 포물선운동(수평으로 던진 물체의 운동)")
