...
# ==========================================
    ...
    with tabs[0]:
        ...
        t = st.slider("시간(s)", 0.0, 3.0, 1.5, key="f_v3")
        fig = go.Figure()
    ...
    with tabs[1]:
        ...
        t = st.slider("시간(s)", 0.0, 3.0, 1.5, key="p_v3")
        fig = go.Figure()
    ...
    with tabs[2]:
        ...
        ang = st.slider("각도(도)", 0, 360, 45, key="c_v3")
        r = np.radians(ang)
        fig = go.Figure()
